...
def load_params(params_path: str = 'config/params.yaml') -> dict:
    try:
...
class ModelTrainer:
    ...
    def __init__(self):
        try:
            ...
            self.trainer_config = ModelTrainerConfig(
                trained_model_path=mt_config['trained_model_path'],
        ...
        try:
            models = {
                ...
                'GradientBoosting': GradientBoostingClassifier(
                    **params['GradientBoosting']   # ← Bug 3 fixed
                ),
                ...
                'SVM': SVC(
                    **params['SVM']                # ← Bug 2 fixed [] not ()
                ),
                'KNN': KNeighborsClassifier(
                    **params['KNN']                # ← Bug 2 fixed [] not ()
                ),
            }
    ...
    def initiate_model_trainer(
        ...
        try:
            ...
            x_train = train_array[:, :-1]    # ← Bug 4 fixed: no trailing comma
